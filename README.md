...
https://www.youtube.com/watch?v=XsY9ijJXigU
...
## Testumgebung
### Kennung <br />
Testprotokoll: DOCTORSTRANGE_edit <br />
Datum: 13.06.2022 <br />
Autor: O. Kadriu

### Beschreibung
Software: DOCTORSTRANGE_edit <br />
Beschreibung: Editiertes Video mit coolen Transitions und Textanimationen <br />
Version: 1

### Testumgebung
Betriebssystem: Windows 11 Home 64 Bit <br />
Hardware: Intel(R) Core(TM) i7-10510U CPU @ 1.80GHz   2.30 GHz


## Testfälle

| **Nummer** | **Vorbereitung** | **Eingabe** | **Erwartete Ausgabe** | **Effektive Ausgabe** |
|:---:|:---:|:---:|:---:|:---:|
|     1.1.1    |     After Effects gestartet/Video oder TV App geöffnet, es wird gewartet,   bis der Benutzer das Video startet    |     Benutzer startet das Video    |     Das Video geht mindestens 15 Sekunden, das heisst erst nach 15.00.00 Sekunden stoppt das Video    |     Das Video stoppt nach genau 19 Sekunden, das heisst das Video ist   länger als 15 Sekunden    |
|     2.2.2    |     After Effects gestartet/Video oder TV App geöffnet, es wird gewartet,   bis der Benutzer das Video startet    |     Benutzer startet das Video    |     Direkt zu Beginn des Videos gibt es eine coole Textanimation    |     Zu Beginn des Videos erscheint eine Textanimation mit dem Text:   "Oltian Kadriu - Doctor Strange". Dieser Text erscheint in einem   Kreis, der aus drei Kreisen besteht und aussehen sollte wie das Portal von   Doctor Strange    |
|     3.3.3    |     After Effects gestartet/Video oder TV App geöffnet, es wird gewartet,   bis der Benutzer das Video startet    |     Benutzer startet das Video und schaltet den Ton von seinem   Ausgabegerät an    |     Nach der Textanimation hört man das Lied "After Dark (tiktok   version)"  im Hintergrund vom   Video    |     Nach der Textanimation ist das Lied "After Dark (tiktok   version)" zu hören    |
|     4.4.4    |     After Effects gestartet/Video oder TV App geöffnet, es wird gewartet,   bis der Benutzer das Video startet    |     Benutzer startet das Video    |     Immer nach einem Videoclip existiert ein cooler Wechsel vom jetzigen   Clip zum nächsten Clip. Es sollten jeweils zwei Transitions zu sehen sein.    |     Nach dem ersten Videoclip erscheint ein "ZOOM IN UND ZOOM   OUT" Tranisition und beim dritten Clip zum vierten Clip erscheint ein   "SWIPE" Transition    |
|     5.5.5    |     After Effects gestartet/Video oder TV App geöffnet, es wird gewartet,   bis der Benutzer das Video startet    |     Benutzer startet das Video    |     Die Videoclips besitzen jeweils eine Qualität von 1080p    |     Die Videoclips sind in full HD vorhanden.    |

## Testprotokoll

| **Nummer** | **Datum** | **Resultat** | **Durchgeführt** |
|:---:|:---:|:---:|:---:|
|      1.1.1    |     13.06.2022    |     OK    |     Kadriu    |
|     2.2.2    |     13.06.2022    |     OK    |     Kadriu    |
|     3.3.3    |     13.06.2022    |     OK    |     Kadriu    |
|     4.4.4    |     13.06.2022    |     OK    |     Kadriu    |
|     5.5.5    |     13.06.2022    |     OK    |     Kadriu    |
